...
public interface zzei extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzei {
        ...
        private static class C1303zza implements zzei {
            private IBinder zzajf;

            C1303zza(IBinder iBinder) {
                this.zzajf = iBinder;
            }
        ...
        public static zzei zzai(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.ads.internal.formats.client.IOnContentAdLoadedListener");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzei)) ? new C1303zza(iBinder) : (zzei) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case 1:
                    ...
                    zza(zzed.zza.zzaf(parcel.readStrongBinder()));
