...
public interface zzr extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzr {
        ...
        private static class C1273zza implements zzr {
            private IBinder zzajf;

            C1273zza(IBinder iBinder) {
                this.zzajf = iBinder;
            }
        ...
        public static zzr zzdr(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzr)) ? new C1273zza(iBinder) : (zzr) queryLocalInterface;
        }
