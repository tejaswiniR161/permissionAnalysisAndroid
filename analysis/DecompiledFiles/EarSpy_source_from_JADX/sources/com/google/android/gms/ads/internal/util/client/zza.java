...
public class zza {
    ...
    public void zza(Context context, @Nullable String str, String str2, Bundle bundle, boolean z) {
        zza(context, str, str2, bundle, z, new C1268zza() {
    ...
    public void zza(Context context, @Nullable String str, String str2, Bundle bundle, boolean z, C1268zza zza) {
        if (z) {
            ...
            if (str == null) {
                str = new StringBuilder(23).append(zzc.zzapd().zzbo(context)).append(".").append(zzf.f1696BA).toString();
            }
