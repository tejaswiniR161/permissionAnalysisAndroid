...
public final class Batch extends zzqe<BatchResult> {
    ...
    /* renamed from: vp */
    public boolean f1508vp;
    /* access modifiers changed from: private */

    /* renamed from: vq */
    public boolean f1509vq;
    /* access modifiers changed from: private */

    /* renamed from: vr */
    public final PendingResult<?>[] f1510vr;
    /* access modifiers changed from: private */
    ...
    public static final class Builder {
        ...
        /* renamed from: kv */
        private GoogleApiClient f1512kv;

        /* renamed from: vt */
        private List<PendingResult<?>> f1513vt = new ArrayList();

        public Builder(GoogleApiClient googleApiClient) {
            this.f1512kv = googleApiClient;
        }

        public <R extends Result> BatchResultToken<R> add(PendingResult<R> pendingResult) {
            BatchResultToken<R> batchResultToken = new BatchResultToken<>(this.f1513vt.size());
            this.f1513vt.add(pendingResult);
            return batchResultToken;
        }

        public Batch build() {
            return new Batch(this.f1513vt, this.f1512kv);
        }
    }
    ...
    private Batch(List<PendingResult<?>> list, GoogleApiClient googleApiClient) {
        ...
        this.f1507vo = list.size();
        this.f1510vr = new PendingResult[this.f1507vo];
        if (list.isEmpty()) {
            zzc(new BatchResult(Status.f1540vY, this.f1510vr));
            return;
        }
        int i = 0;
        while (true) {
                ...
                pendingResult.zza(new PendingResult.zza() {
                    ...
                    public void zzv(com.google.android.gms.common.api.Status r6) {
                        ...
                        L_0x0011:
                            ...
                            com.google.android.gms.common.api.Batch r0 = com.google.android.gms.common.api.Batch.this     // Catch:{ all -> 0x0039 }
                            r2 = 1
                            boolean unused = r0.f1509vq = r2     // Catch:{ all -> 0x0039 }
                        L_0x001d:
                            com.google.android.gms.common.api.Batch r0 = com.google.android.gms.common.api.Batch.this     // Catch:{ all -> 0x0039 }
                            com.google.android.gms.common.api.Batch.zzb(r0)     // Catch:{ all -> 0x0039 }
                            com.google.android.gms.common.api.Batch r0 = com.google.android.gms.common.api.Batch.this     // Catch:{ all -> 0x0039 }
                            int r0 = r0.f1507vo     // Catch:{ all -> 0x0039 }
                            if (r0 != 0) goto L_0x0037
                            com.google.android.gms.common.api.Batch r0 = com.google.android.gms.common.api.Batch.this     // Catch:{ all -> 0x0039 }
                            boolean r0 = r0.f1509vq     // Catch:{ all -> 0x0039 }
                        ...
                        L_0x003c:
                            ...
                            com.google.android.gms.common.api.Batch r0 = com.google.android.gms.common.api.Batch.this     // Catch:{ all -> 0x0039 }
                            r2 = 1
                            boolean unused = r0.f1508vp = r2     // Catch:{ all -> 0x0039 }
                            goto L_0x001d
                        L_0x0049:
                            com.google.android.gms.common.api.Batch r0 = com.google.android.gms.common.api.Batch.this     // Catch:{ all -> 0x0039 }
                            boolean r0 = r0.f1508vp     // Catch:{ all -> 0x0039 }
                        ...
                        L_0x0058:
                            ...
                            com.google.android.gms.common.api.PendingResult[] r4 = r4.f1510vr     // Catch:{ all -> 0x0039 }
                            r3.<init>(r0, r4)     // Catch:{ all -> 0x0039 }
                            r2.zzc(r3)     // Catch:{ all -> 0x0039 }
                            goto L_0x0037
                        L_0x0069:
                            com.google.android.gms.common.api.Status r0 = com.google.android.gms.common.api.Status.f1540vY     // Catch:{ all -> 0x0039 }
                            goto L_0x0058
                        */
                        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.common.api.Batch.C07081.zzv(com.google.android.gms.common.api.Status):void");
                    }
                });
                i = i2 + 1;
            } else {
    ...
    public void cancel() {
        super.cancel();
        for (PendingResult<?> cancel : this.f1510vr) {
            cancel.cancel();
        }
    }
    ...
    public BatchResult zzc(Status status) {
        return new BatchResult(status, this.f1510vr);
    }
}
