...
public interface zzed extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzed {
        ...
        private static class C1300zza implements zzed {
            private IBinder zzajf;

            C1300zza(IBinder iBinder) {
                this.zzajf = iBinder;
            }
        ...
        public static zzed zzaf(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzed)) ? new C1300zza(iBinder) : (zzed) queryLocalInterface;
        }
