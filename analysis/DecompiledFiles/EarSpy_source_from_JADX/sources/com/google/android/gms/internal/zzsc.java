...
public interface zzsc extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzsc {
        ...
        private static class C1325zza implements zzsc {
        ...
        public static zzsc zzeb(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzsc)) ? new C1325zza(iBinder) : (zzsc) queryLocalInterface;
        }
