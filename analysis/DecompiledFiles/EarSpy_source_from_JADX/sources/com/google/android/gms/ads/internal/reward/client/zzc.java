...
public interface zzc extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzc {
        ...
        private static class C1264zza implements zzc {
            private IBinder zzajf;

            C1264zza(IBinder iBinder) {
                this.zzajf = iBinder;
            }
            ...
            public IBinder zza(zzd zzd, zzgq zzgq, int i) throws RemoteException {
        ...
        public static zzc zzbi(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzc)) ? new C1264zza(iBinder) : (zzc) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case 1:
                    ...
                    IBinder zza = zza(zzd.zza.zzfe(parcel.readStrongBinder()), zzgq.zza.zzam(parcel.readStrongBinder()), parcel.readInt());
    ...
    IBinder zza(zzd zzd, zzgq zzgq, int i) throws RemoteException;
}
