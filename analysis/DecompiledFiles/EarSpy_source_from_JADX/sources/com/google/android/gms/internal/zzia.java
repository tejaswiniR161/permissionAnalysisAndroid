...
public interface zzia extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzia {

        /* renamed from: com.google.android.gms.internal.zzia$zza$zza  reason: collision with other inner class name */
        private static class C1318zza implements zzia {
            private IBinder zzajf;

            C1318zza(IBinder iBinder) {
                this.zzajf = iBinder;
            }
        ...
        public static zzia zzba(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzia)) ? new C1318zza(iBinder) : (zzia) queryLocalInterface;
        }
