...
public interface zzw extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzw {
        ...
        private static class C1253zza implements zzw {
            private IBinder zzajf;

            C1253zza(IBinder iBinder) {
                this.zzajf = iBinder;
            }
        ...
        public static zzw zzs(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzw)) ? new C1253zza(iBinder) : (zzw) queryLocalInterface;
        }
