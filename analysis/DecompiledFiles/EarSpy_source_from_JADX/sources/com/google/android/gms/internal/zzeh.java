...
public interface zzeh extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzeh {
        ...
        private static class C1302zza implements zzeh {
            private IBinder zzajf;

            C1302zza(IBinder iBinder) {
                this.zzajf = iBinder;
            }
        ...
        public static zzeh zzah(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzeh)) ? new C1302zza(iBinder) : (zzeh) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case 1:
                    ...
                    zza(zzeb.zza.zzae(parcel.readStrongBinder()));
