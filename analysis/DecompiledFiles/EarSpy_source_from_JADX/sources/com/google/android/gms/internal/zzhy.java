...
public interface zzhy extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzhy {
        ...
        private static class C1316zza implements zzhy {
            private IBinder zzajf;

            C1316zza(IBinder iBinder) {
                this.zzajf = iBinder;
            }
        ...
        public static zzhy zzay(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzhy)) ? new C1316zza(iBinder) : (zzhy) queryLocalInterface;
        }
