...
public interface zzhz extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzhz {
        ...
        private static class C1317zza implements zzhz {
            private IBinder zzajf;

            C1317zza(IBinder iBinder) {
                this.zzajf = iBinder;
            }
            ...
            public IBinder zzp(zzd zzd) throws RemoteException {
        ...
        public static zzhz zzaz(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzhz)) ? new C1317zza(iBinder) : (zzhz) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case 1:
                    ...
                    IBinder zzp = zzp(zzd.zza.zzfe(parcel.readStrongBinder()));
    ...
    IBinder zzp(zzd zzd) throws RemoteException;
}
