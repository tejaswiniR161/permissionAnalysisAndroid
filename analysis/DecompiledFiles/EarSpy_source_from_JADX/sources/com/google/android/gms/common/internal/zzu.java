...
public interface zzu extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzu {
        ...
        private static class C1276zza implements zzu {
            private IBinder zzajf;

            C1276zza(IBinder iBinder) {
                this.zzajf = iBinder;
            }
        ...
        public static zzu zzdu(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzu)) ? new C1276zza(iBinder) : (zzu) queryLocalInterface;
        }
