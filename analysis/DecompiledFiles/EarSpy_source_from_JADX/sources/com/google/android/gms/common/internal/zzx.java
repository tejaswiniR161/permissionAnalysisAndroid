...
public interface zzx extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzx {
        ...
        private static class C1279zza implements zzx {
            private IBinder zzajf;

            C1279zza(IBinder iBinder) {
                this.zzajf = iBinder;
            }
        ...
        public static zzx zzdx(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzx)) ? new C1279zza(iBinder) : (zzx) queryLocalInterface;
        }
