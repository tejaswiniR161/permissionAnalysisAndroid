...
public interface zzek extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzek {
        ...
        private static class C1305zza implements zzek {
            private IBinder zzajf;

            C1305zza(IBinder iBinder) {
                this.zzajf = iBinder;
            }
            ...
            public void zza(zzef zzef) throws RemoteException {
        ...
        public static zzek zzak(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.ads.internal.formats.client.IOnCustomTemplateAdLoadedListener");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzek)) ? new C1305zza(iBinder) : (zzek) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case 1:
                    ...
                    zza(zzef.zza.zzag(parcel.readStrongBinder()));
    ...
    void zza(zzef zzef) throws RemoteException;
}
