...
public interface zzdt extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzdt {
        ...
        private static class C1294zza implements zzdt {
            private IBinder zzajf;

            C1294zza(IBinder iBinder) {
                this.zzajf = iBinder;
            }
        ...
        public static zzdt zzz(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzdt)) ? new C1294zza(iBinder) : (zzdt) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                ...
                case 3:
                    parcel.enforceInterface("com.google.android.gms.ads.internal.customrenderedad.client.ICustomRenderedAd");
                    zzi(zzd.zza.zzfe(parcel.readStrongBinder()));
                    parcel2.writeNoException();
                    return true;
                case 4:
                    parcel.enforceInterface("com.google.android.gms.ads.internal.customrenderedad.client.ICustomRenderedAd");
