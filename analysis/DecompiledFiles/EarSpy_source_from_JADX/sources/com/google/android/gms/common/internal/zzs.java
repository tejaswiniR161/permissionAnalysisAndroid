...
public interface zzs extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzs {
        ...
        private static class C1274zza implements zzs {
            private IBinder zzajf;

            C1274zza(IBinder iBinder) {
                this.zzajf = iBinder;
            }
        ...
        public static zzs zzds(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzs)) ? new C1274zza(iBinder) : (zzs) queryLocalInterface;
        }
