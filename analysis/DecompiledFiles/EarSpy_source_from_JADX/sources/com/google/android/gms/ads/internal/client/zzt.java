...
public interface zzt extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzt {
        ...
        private static class C1250zza implements zzt {
            private IBinder zzajf;

            C1250zza(IBinder iBinder) {
                this.zzajf = iBinder;
            }
            ...
            public IBinder zza(zzd zzd, String str, zzgq zzgq, int i) throws RemoteException {
        ...
        public static zzt zzp(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzt)) ? new C1250zza(iBinder) : (zzt) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case 1:
                    ...
                    IBinder zza = zza(zzd.zza.zzfe(parcel.readStrongBinder()), parcel.readString(), zzgq.zza.zzam(parcel.readStrongBinder()), parcel.readInt());
    ...
    IBinder zza(zzd zzd, String str, zzgq zzgq, int i) throws RemoteException;
}
