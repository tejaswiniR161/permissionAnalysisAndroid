...
public interface zzej extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzej {
        ...
        private static class C1304zza implements zzej {
            private IBinder zzajf;

            C1304zza(IBinder iBinder) {
                this.zzajf = iBinder;
            }
            ...
            public void zza(zzef zzef, String str) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.ads.internal.formats.client.IOnCustomClickListener");
                    obtain.writeStrongBinder(zzef != null ? zzef.asBinder() : null);
        ...
        public static zzej zzaj(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.ads.internal.formats.client.IOnCustomClickListener");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzej)) ? new C1304zza(iBinder) : (zzej) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case 1:
                    ...
                    zza(zzef.zza.zzag(parcel.readStrongBinder()), parcel.readString());
    ...
    void zza(zzef zzef, String str) throws RemoteException;
}
