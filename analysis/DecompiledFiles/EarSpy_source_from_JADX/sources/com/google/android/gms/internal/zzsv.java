...
public interface zzsv extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzsv {
        ...
        private static class C1328zza implements zzsv {
        ...
        public static zzsv zzff(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzsv)) ? new C1328zza(iBinder) : (zzsv) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                ...
                case 2:
                    parcel.enforceInterface("com.google.android.gms.dynamite.IDynamiteLoader");
                    zzd zza = zza(zzd.zza.zzfe(parcel.readStrongBinder()), parcel.readString(), parcel.readInt());
                    parcel2.writeNoException();
