...
public interface zzhq extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzhq {
        ...
        private static class C1313zza implements zzhq {
            private IBinder zzajf;

            C1313zza(IBinder iBinder) {
                this.zzajf = iBinder;
            }
            ...
            public IBinder zzo(zzd zzd) throws RemoteException {
        ...
        public static zzhq zzau(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.ads.internal.overlay.client.IAdOverlayCreator");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzhq)) ? new C1313zza(iBinder) : (zzhq) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case 1:
                    ...
                    IBinder zzo = zzo(zzd.zza.zzfe(parcel.readStrongBinder()));
    ...
    IBinder zzo(zzd zzd) throws RemoteException;
}
