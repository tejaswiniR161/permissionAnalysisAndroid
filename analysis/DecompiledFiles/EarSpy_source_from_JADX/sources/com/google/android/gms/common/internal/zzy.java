...
public interface zzy extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzy {
        ...
        private static class C1280zza implements zzy {
            private IBinder zzajf;

            C1280zza(IBinder iBinder) {
                this.zzajf = iBinder;
            }
        ...
        public static zzy zzdy(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzy)) ? new C1280zza(iBinder) : (zzy) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            switch (i) {
                case 1:
                    ...
                    zzd zza = zza(zzd.zza.zzfe(parcel.readStrongBinder()), parcel.readInt(), parcel.readInt());
                    parcel2.writeNoException();
                    parcel2.writeStrongBinder(zza != null ? zza.asBinder() : null);
                    return true;
                case 2:
                    parcel.enforceInterface("com.google.android.gms.common.internal.ISignInButtonCreator");
                    zzd zza2 = zza(zzd.zza.zzfe(parcel.readStrongBinder()), parcel.readInt() != 0 ? SignInButtonConfig.CREATOR.createFromParcel(parcel) : null);
                    parcel2.writeNoException();
                    if (zza2 != null) {
