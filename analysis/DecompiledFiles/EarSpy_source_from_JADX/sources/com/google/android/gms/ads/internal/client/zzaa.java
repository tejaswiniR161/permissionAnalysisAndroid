...
public interface zzaa extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzaa {
        ...
        private static class C1243zza implements zzaa {
            private IBinder zzajf;

            C1243zza(IBinder iBinder) {
                this.zzajf = iBinder;
            }
        ...
        public static zzaa zzv(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzaa)) ? new C1243zza(iBinder) : (zzaa) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case 1:
                    ...
                    IBinder zza = zza(zzd.zza.zzfe(parcel.readStrongBinder()), parcel.readInt());
