...
public interface zzhw extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzhw {
        ...
        /* renamed from: com.google.android.gms.internal.zzhw$zza$zza  reason: collision with other inner class name */
        private static class C1314zza implements zzhw {
            private IBinder zzajf;

            C1314zza(IBinder iBinder) {
                this.zzajf = iBinder;
            }
        ...
        public static zzhw zzaw(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzhw)) ? new C1314zza(iBinder) : (zzhw) queryLocalInterface;
        }
