...
public interface zzdu extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzdu {
        ...
        private static class C1295zza implements zzdu {
            private IBinder zzajf;

            C1295zza(IBinder iBinder) {
                this.zzajf = iBinder;
            }
            ...
            public void zza(zzdt zzdt) throws RemoteException {
                ...
                try {
                    ...
                    obtain.writeStrongBinder(zzdt != null ? zzdt.asBinder() : null);
        ...
        public static zzdu zzaa(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzdu)) ? new C1295zza(iBinder) : (zzdu) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case 1:
                    ...
                    zza(zzdt.zza.zzz(parcel.readStrongBinder()));
