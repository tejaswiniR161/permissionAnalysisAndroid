...
public final class zzl {
    ...
    public static zza<Integer> aoN = zza.zzab("measurement.upload.max_events_per_bundle", AdError.NETWORK_ERROR_CODE);
    public static zza<Integer> aoO = zza.zzab("measurement.upload.max_events_per_day", 100000);
    public static zza<Integer> aoP = zza.zzab("measurement.upload.max_error_events_per_day", AdError.NETWORK_ERROR_CODE);
    ...
    public static zza<Long> apa = zza.zzh("measurement.alarm_manager.minimum_interval", 60000);
    ...
    public static zza<Long> api = zza.zzh("measurement.service_client.idle_disconnect_millis", 5000);

    public static final class zza<V> {

        /* renamed from: cV */
        private final V f2286cV;

        /* renamed from: cW */
        private final zzrs<V> f2287cW;
        private final String zzbaf;

        private zza(String str, zzrs<V> zzrs, V v) {
            zzac.zzy(zzrs);
            this.f2287cW = zzrs;
            this.f2286cV = v;
            this.zzbaf = str;
