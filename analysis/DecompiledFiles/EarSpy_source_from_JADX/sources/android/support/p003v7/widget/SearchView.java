...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public SearchView(Context context, AttributeSet attrs) {
        this(context, attrs, C0167R.attr.searchViewStyle);
    }
    ...
    public SearchView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0167R.styleable.SearchView, defStyleAttr, 0);
        this.mTintManager = a.getTintManager();
        LayoutInflater.from(context).inflate(a.getResourceId(C0167R.styleable.SearchView_layout, C0167R.layout.abc_search_view), this, true);
        this.mSearchSrcTextView = (SearchAutoComplete) findViewById(C0167R.C0169id.search_src_text);
        this.mSearchSrcTextView.setSearchView(this);
        this.mSearchEditFrame = findViewById(C0167R.C0169id.search_edit_frame);
        this.mSearchPlate = findViewById(C0167R.C0169id.search_plate);
        this.mSubmitArea = findViewById(C0167R.C0169id.submit_area);
        this.mSearchButton = (ImageView) findViewById(C0167R.C0169id.search_button);
        this.mGoButton = (ImageView) findViewById(C0167R.C0169id.search_go_btn);
        this.mCloseButton = (ImageView) findViewById(C0167R.C0169id.search_close_btn);
        this.mVoiceButton = (ImageView) findViewById(C0167R.C0169id.search_voice_btn);
        this.mCollapsedIcon = (ImageView) findViewById(C0167R.C0169id.search_mag_icon);
        this.mSearchPlate.setBackgroundDrawable(a.getDrawable(C0167R.styleable.SearchView_queryBackground));
        this.mSubmitArea.setBackgroundDrawable(a.getDrawable(C0167R.styleable.SearchView_submitBackground));
        this.mSearchButton.setImageDrawable(a.getDrawable(C0167R.styleable.SearchView_searchIcon));
        this.mGoButton.setImageDrawable(a.getDrawable(C0167R.styleable.SearchView_goIcon));
        this.mCloseButton.setImageDrawable(a.getDrawable(C0167R.styleable.SearchView_closeIcon));
        this.mVoiceButton.setImageDrawable(a.getDrawable(C0167R.styleable.SearchView_voiceIcon));
        this.mCollapsedIcon.setImageDrawable(a.getDrawable(C0167R.styleable.SearchView_searchIcon));
        this.mSearchHintIcon = a.getDrawable(C0167R.styleable.SearchView_searchHintIcon);
        this.mSuggestionRowLayout = a.getResourceId(C0167R.styleable.SearchView_suggestionRowLayout, C0167R.layout.abc_search_dropdown_item_icons_2line);
        this.mSuggestionCommitIconResId = a.getResourceId(C0167R.styleable.SearchView_commitIcon, 0);
        ...
        setIconifiedByDefault(a.getBoolean(C0167R.styleable.SearchView_iconifiedByDefault, true));
        int maxWidth = a.getDimensionPixelSize(C0167R.styleable.SearchView_android_maxWidth, -1);
        if (maxWidth != -1) {
            setMaxWidth(maxWidth);
        }
        CharSequence queryHint = a.getText(C0167R.styleable.SearchView_queryHint);
        if (!TextUtils.isEmpty(queryHint)) {
            setQueryHint(queryHint);
        }
        int imeOptions = a.getInt(C0167R.styleable.SearchView_android_imeOptions, -1);
        if (imeOptions != -1) {
            setImeOptions(imeOptions);
        }
        int inputType = a.getInt(C0167R.styleable.SearchView_android_inputType, -1);
        if (inputType != -1) {
            setInputType(inputType);
        }
        setFocusable(a.getBoolean(C0167R.styleable.SearchView_android_focusable, true));
        a.recycle();
    ...
    private int getPreferredWidth() {
        return getContext().getResources().getDimensionPixelSize(C0167R.dimen.abc_search_view_preferred_width);
    }
    ...
    public void adjustDropDownSizeAndPosition() {
        ...
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            int iconOffset = this.mIconifiedByDefault ? res.getDimensionPixelSize(C0167R.dimen.abc_dropdownitem_icon_width) + res.getDimensionPixelSize(C0167R.dimen.abc_dropdownitem_text_padding_left) : 0;
