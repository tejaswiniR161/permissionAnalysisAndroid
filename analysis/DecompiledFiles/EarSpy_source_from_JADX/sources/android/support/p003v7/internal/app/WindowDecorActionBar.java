...
public class WindowDecorActionBar extends ActionBar implements ActionBarOverlayLayout.ActionBarVisibilityCallback {
    ...
    private void init(View decor) {
        ...
        boolean homeAsUp;
        boolean z;
        this.mOverlayLayout = (ActionBarOverlayLayout) decor.findViewById(C0167R.C0169id.decor_content_parent);
        if (this.mOverlayLayout != null) {
            this.mOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(decor.findViewById(C0167R.C0169id.action_bar));
        this.mContextView = (ActionBarContextView) decor.findViewById(C0167R.C0169id.action_context_bar);
        this.mContainerView = (ActionBarContainer) decor.findViewById(C0167R.C0169id.action_bar_container);
        this.mSplitView = (ActionBarContainer) decor.findViewById(C0167R.C0169id.split_action_bar);
        ...
        TypedArray a = this.mContext.obtainStyledAttributes((AttributeSet) null, C0167R.styleable.ActionBar, C0167R.attr.actionBarStyle, 0);
        if (a.getBoolean(C0167R.styleable.ActionBar_hideOnContentScroll, false)) {
            setHideOnContentScrollEnabled(true);
        }
        int elevation = a.getDimensionPixelSize(C0167R.styleable.ActionBar_elevation, 0);
        if (elevation != 0) {
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0167R.attr.actionBarWidgetTheme, outValue, true);
