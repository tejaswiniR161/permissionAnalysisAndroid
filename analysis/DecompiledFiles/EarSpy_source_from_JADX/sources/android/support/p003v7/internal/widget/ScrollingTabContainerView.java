...
public class ScrollingTabContainerView extends HorizontalScrollView implements AdapterViewCompat.OnItemClickListener {
    ...
    private LinearLayoutCompat createTabLayout() {
        LinearLayoutCompat tabLayout = new LinearLayoutCompat(getContext(), (AttributeSet) null, C0167R.attr.actionBarTabBarStyle);
    ...
    private SpinnerCompat createSpinner() {
        SpinnerCompat spinner = new SpinnerCompat(getContext(), (AttributeSet) null, C0167R.attr.actionDropDownStyle);
    ...
    private class TabView extends LinearLayoutCompat implements View.OnLongClickListener {
        ...
        public TabView(Context context, ActionBar.Tab tab, boolean forList) {
            super(context, (AttributeSet) null, C0167R.attr.actionBarTabStyle);
            this.mTab = tab;
            TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, (AttributeSet) null, this.BG_ATTRS, C0167R.attr.actionBarTabStyle, 0);
            if (a.hasValue(0)) {
        ...
        public void update() {
            ...
            if (hasText) {
                if (this.mTextView == null) {
                    TextView textView = new AppCompatTextView(getContext(), (AttributeSet) null, C0167R.attr.actionBarTabTextStyle);
