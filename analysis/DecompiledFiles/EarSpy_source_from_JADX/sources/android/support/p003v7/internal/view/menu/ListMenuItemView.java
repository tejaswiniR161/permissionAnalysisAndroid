...
public class ListMenuItemView extends LinearLayout implements MenuView.ItemView {
    ...
    public ListMenuItemView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0167R.styleable.MenuView, defStyle, 0);
        this.mBackground = a.getDrawable(C0167R.styleable.MenuView_android_itemBackground);
        this.mTextAppearance = a.getResourceId(C0167R.styleable.MenuView_android_itemTextAppearance, -1);
        this.mPreserveIconSpacing = a.getBoolean(C0167R.styleable.MenuView_preserveIconSpacing, false);
    ...
    public void onFinishInflate() {
        ...
        this.mTitleView = (TextView) findViewById(C0167R.C0169id.title);
        if (this.mTextAppearance != -1) {
            this.mTitleView.setTextAppearance(this.mTextAppearanceContext, this.mTextAppearance);
        }
        this.mShortcutView = (TextView) findViewById(C0167R.C0169id.shortcut);
    }
    ...
    private void insertIconView() {
        this.mIconView = (ImageView) getInflater().inflate(C0167R.layout.abc_list_menu_item_icon, this, false);
        addView(this.mIconView, 0);
    }

    private void insertRadioButton() {
        this.mRadioButton = (RadioButton) getInflater().inflate(C0167R.layout.abc_list_menu_item_radio, this, false);
        addView(this.mRadioButton);
    }

    private void insertCheckBox() {
        this.mCheckBox = (CheckBox) getInflater().inflate(C0167R.layout.abc_list_menu_item_checkbox, this, false);
