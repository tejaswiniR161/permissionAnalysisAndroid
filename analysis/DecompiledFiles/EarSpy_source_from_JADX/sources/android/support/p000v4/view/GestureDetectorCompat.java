            ...
            switch (action & 255) {
                ...
                case 1:
                    ...
                    if (this.mIsDoubleTapping) {
                        ...
                        velocityTracker.computeCurrentVelocity(AdError.NETWORK_ERROR_CODE, (float) this.mMaximumFlingVelocity);
                ...
                case 6:
                    ...
                    this.mLastFocusY = focusY;
                    this.mDownFocusY = focusY;
                    this.mVelocityTracker.computeCurrentVelocity(AdError.NETWORK_ERROR_CODE, (float) this.mMaximumFlingVelocity);
