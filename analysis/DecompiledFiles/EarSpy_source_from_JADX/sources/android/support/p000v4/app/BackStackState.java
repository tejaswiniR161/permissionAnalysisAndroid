...
final class BackStackState implements Parcelable {
    ...
    public BackStackState(BackStackRecord bse) {
        int pos;
        int numRemoved = 0;
        for (BackStackRecord.C0010Op op = bse.mHead; op != null; op = op.next) {
            if (op.removed != null) {
        ...
        BackStackRecord.C0010Op op2 = bse.mHead;
        int pos2 = 0;
        while (op2 != null) {
            int pos3 = pos2 + 1;
    ...
    public BackStackRecord instantiate(FragmentManagerImpl fm) {
        ...
        while (pos < this.mOps.length) {
            BackStackRecord.C0010Op op = new BackStackRecord.C0010Op();
            int pos2 = pos + 1;
