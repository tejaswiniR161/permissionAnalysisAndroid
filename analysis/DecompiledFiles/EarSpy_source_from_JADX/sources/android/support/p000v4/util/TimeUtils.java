...
public class TimeUtils {
    ...
    private static int formatDurationLocked(long duration, int fieldLen) {
        ...
        int pos5 = printField(formatStr, minutes, AppLovinTargetingData.GENDER_MALE, pos4, pos4 != start, zeropad ? 2 : 0);
        int pos6 = printField(formatStr, seconds, 's', pos5, pos5 != start, zeropad ? 2 : 0);
        int pos7 = printField(formatStr, millis, AppLovinTargetingData.GENDER_MALE, pos6, true, (!zeropad || pos6 == start) ? 0 : 3);
        formatStr[pos7] = 's';
        return pos7 + 1;
    }
